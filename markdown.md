...
### HTML
Markdown поддерживает использование прямого HTML внутри документа, так что вы можете использовать любые HTML-теги для более сложного оформления:<br>
`<kbd>CTRL</kbd> + <kbd>P</kbd>`<br>
<kbd>CTRL</kbd> + <kbd>P</kbd>
<div id='comment'/> 
    
### Комментарии
`<!-- Это комментарий, он не будет отображаться-->`<br>
пример: <br>
...
Вы можете использовать эмодзи в своих Markdown-файлах. Вот некоторые из них:
```
:smile:
:laughing:
:blush:
